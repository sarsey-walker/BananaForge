...
class TransparencyNotifier:
    ...
    def create_notification(
        self, transparency_info: TransparencyInfo
    ...
    def _create_no_transparency_notification(
    ...
    def _create_high_transparency_notification(
        self, info: TransparencyInfo
    ) -> TransparencyNotification:
    ...
    def _create_moderate_transparency_notification(
        self, info: TransparencyInfo
    ) -> TransparencyNotification:
    ...
    def _create_minimal_transparency_notification(
        self, info: TransparencyInfo
    ) -> TransparencyNotification:
...
class TransparencyException(Exception):
    ...
    def get_cli_message(
        self, show_technical: bool = False, show_suggestions: bool = True
    ) -> str:
